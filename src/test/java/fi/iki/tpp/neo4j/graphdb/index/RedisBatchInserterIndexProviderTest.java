...
/**
 * Tests the batch inserter index provider against a 
 * @author tpp
 *
 */
public class RedisBatchInserterIndexProviderTest {
	...
	public void testSingleProperty() {
		...
		BatchInserterIndexProvider provider = new RedisBatchInserterIndexProvider();

		String indexName = "users1";
	...
	private static Map<String, String> createConfig() {
		return MapUtil.stringMap( "redis.db.host", HOSTNAME, "redis.db.port", PORT );
	}
}
